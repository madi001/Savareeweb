...
class parseUser extends parseRestClient{
	...
	public function signup($username='',$password='' , $cell='' ,$org='',$genderFilter='',$gender='' ,$name='', $email='', $country='' , $opencarpooling=''){
...
public function socialLogin(){
	...
	public function updateRating($objectId,$rating){
		if(!empty($objectId)){
			$this->rating = $rating;
			...
			$this->throwError('Ratting cannot be get');
		}
